...
func main() {
	...
	// Omit the "Auto generated by spf13/cobra on <date>" footer. It changes
	// every day, which made the docs-check workflow fail on any day other
	// than the one the docs were last generated on.
